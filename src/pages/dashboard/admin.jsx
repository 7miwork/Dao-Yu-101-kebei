      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gray-900 font-medium">{t("admin.userManagement")}</span>
          </div>
        </Card>
        ...
        <Card>
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gray-900 font-medium">{t("admin.systemSettings")}</span>
          </div>
        </Card>
        ...
        <Card>
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gray-900 font-medium">{t("admin.analytics")}</span>
          </div>
        </Card>
        ...
        <Card>
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gray-900 font-medium">{t("admin.platformMaintenance")}</span>
          </div>
        </Card>
        ...
        <Card>
          <div className="flex items-center space-x-3">
            ...
            <span className="text-gray-900 font-medium">{t("admin.security")}</span>
          </div>
        </Card>
        ...
        <Card className="md:col-span-2 lg:col-span-3" gradient={true} hover={false}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">{t("admin.dataStored")}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">v2.1.0</div>
              <div className="text-sm text-gray-600">{t("admin.platformVersion")}</div>
            </div>
          </div>
        </Card>
      </div>
